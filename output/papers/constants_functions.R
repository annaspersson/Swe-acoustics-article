...
colors.all.procedures <- c("#100C08", "#C9C0BB", "#C9C0BB", "#C9C0BB", "#C9C0BB", "#C9C0BB", "#E6BE8A", "#E6BE8A","#E6BE8A", "#ABCDEF", "#ABCDEF", "#ABCDEF", "#ABCDEF", "#ABCDEF", "#ABCDEF", "#ABCDEF", "#DDADAF", "#DDADAF")
...
get_Z_score <- function(n1, n2, p1, p2) {
  (p1-p2) /
    sqrt((p1*n1 - p2*n2 / n1+n2) * (1-(p1*n1 - p2*n2) / n1+n2) * (1/n1 + 1/n2))
}
