...
abstract: The Swedish vowel space is relatively densely populated with 21 categories that differ in quality and quantity. Existing descriptions of the entire space rest on recordings made in the late 1990s or earlier, while recent work in general has focused on sub-sets of the space. The present paper reports two studies. The first presents static and dynamic acoustic analyses of the entire vowel space using a recently released database of *h-VOWEL-d* words (SwehVd). The second study compares the acoustic characteristics of SwehVd against formant data from 8 talkers of the same dialect recorded in 1999, to investigate the extent to which the phonetic realization of vowels has changed over the last generation. The results highlight the importance of static and dynamic spectral and temporal cues for Swedish vowel category distinction, and indicate possible ongoing shifts in the high front part of the space
...
The methodology employed in the static and dynamic analyses in Study 1 is presented next, beginning with a description of the materials used.
...
The category separability was calculated for the [`r linguisticsdown::cond_cmpl("iː")`] - [`r linguisticsdown::cond_cmpl("yː")`], [`r linguisticsdown::cond_cmpl("eː")`] - [`r linguisticsdown::cond_cmpl("yː")`] and [`r linguisticsdown::cond_cmpl("ɪ")`] - [`r linguisticsdown::cond_cmpl("ʏ")`] contrasts, assessing the effect of F3 on unrounded vs. rounded neighboring vowels, and for the [`r linguisticsdown::cond_cmpl("yː")`] - [`r linguisticsdown::cond_cmpl("ʉː")`], [`r linguisticsdown::cond_cmpl("oː")`] - [`r linguisticsdown::cond_cmpl("uː")`] and [`r linguisticsdown::cond_cmpl("ɔ")`] - [`r linguisticsdown::cond_cmpl("ʊ")`] contrasts, assessing the effect of F3 on outrounded vs. inrounded neighboring vowels.^[To capture possible differences in separability between vowels in a contrast, the separability index was first calculated in both directions, that is, both assessing the separability of [`r linguisticsdown::cond_cmpl("iː")`] from [`r linguisticsdown::cond_cmpl("yː")`], and [`r linguisticsdown::cond_cmpl("yː")`] from [`r linguisticsdown::cond_cmpl("iː")`], following @xie-jaeger2020. Given that no significant differences in directionality were found, the separability index reports the average separability across the two categories in each contrast.]

Two general observations can be made from Figure \@ref(fig:cat-sep-F3). Category separability was overall lower for some contrasts when only F1 and F2 were considered, e.g., the [`r linguisticsdown::cond_cmpl("iː")`] - [`r linguisticsdown::cond_cmpl("yː")`], and [`r linguisticsdown::cond_cmpl("ɪ")`] - [`r linguisticsdown::cond_cmpl("ʏ")`] contrasts, presumably indicating their overlap in F1-F2 space. Second, including F3 increased overall category separability, but only marginally for most contrasts. The contrast that seem to benefit most from the inclusion of F3 is the [`r linguisticsdown::cond_cmpl("yː")`] - [`r linguisticsdown::cond_cmpl("ʉː")`] contrast. 

The LMMs fit to the data (presented in Section \@ref(sec:method-static)) indicated that including F3 improved category separability for all contrasts (all $ps < .001$). This suggests that the subtle differences observed by visual inspection were nevertheless significant (Summary tables in SI \@ref(sec:SI-LMMs-study1)).
...
Figure \@ref(fig:cat-sep-long-short) shows the comparison of separability indices for all long-short vowel pairs as a function of cue combination. The figure indicates that category separability is generally higher for some pairs, e.g., [`r linguisticsdown::cond_cmpl("eː")`] - [`r linguisticsdown::cond_cmpl("ɛ")`], [`r linguisticsdown::cond_cmpl("ʉː")`] - [`r linguisticsdown::cond_cmpl("ɵ")`], and [`r linguisticsdown::cond_cmpl("ɑː")`] - [`r linguisticsdown::cond_cmpl("a")`], and that the F1-F2-F3 combination overall maximizes separability between the pairs, although the difference to the F1-F2 space appears marginal for most pairs. This would seem to suggest that the first two formants are the most important cues to long-short vowel pair distinctions, while the inclusion of an additional cue unsurprisingly does not punish the separability. Third, for the F1-F3 and F2-F3 cue spaces, there seems to be two main groups for which either cue combination generates the lowest separability index. For the [`r linguisticsdown::cond_cmpl("ʉː")`] - [`r linguisticsdown::cond_cmpl("ɵ")`], [`r linguisticsdown::cond_cmpl("ɑː")`] - [`r linguisticsdown::cond_cmpl("a")`], [`r linguisticsdown::cond_cmpl("oː")`] - [`r linguisticsdown::cond_cmpl("ɔ")`], [`r linguisticsdown::cond_cmpl("iː")`] - [`r linguisticsdown::cond_cmpl("ɪ")`], and [`r linguisticsdown::cond_cmpl("uː")`] - [`r linguisticsdown::cond_cmpl("ʊ")`] vowel pairs, the F1-F3 cue combination generates the lowest separability, which would seem to suggest the informativity of F2 for distinguishing between these pairs. The second group mainly consists of allophones to /`r linguisticsdown::cond_cmpl("ɛ")`/ and /`r linguisticsdown::cond_cmpl("ø")`/: [`r linguisticsdown::cond_cmpl("eː")`] - [`r linguisticsdown::cond_cmpl("ɛ")`], [`r linguisticsdown::cond_cmpl("ɛː")`] - [`r linguisticsdown::cond_cmpl("ɛ")`], [`r linguisticsdown::cond_cmpl("æː")`] - [`r linguisticsdown::cond_cmpl("æ")`], [`r linguisticsdown::cond_cmpl("øː")`] - [`r linguisticsdown::cond_cmpl("ø")`] and [`r linguisticsdown::cond_cmpl("œː")`] - [`r linguisticsdown::cond_cmpl("œ")`]. For these vowel pairs, F2-F3 cue combination produces the lowest category separability, presumably highlighting the importance of F1. Interestingly, the [`r linguisticsdown::cond_cmpl("yː")`] - [`r linguisticsdown::cond_cmpl("ʏ")`] pair generates almost identical separability index in F1-F2 and F1-F3 spaces, and increased separability for both F2-F3 and F1-F2-F3, which seems to signal the importance of all three cues.

These findings were confirmed by the statistical analysis (Summary tables in SI \@ref(sec:SI-LMMs-study1)). The LMMs indicated that the F1-F2-F3 cue combination generated the highest separability, however, for all but the [`r linguisticsdown::cond_cmpl("yː")`] - [`r linguisticsdown::cond_cmpl("ʏ")`] ($\hat\beta = .025, SE = .006, p < .0001$) and [`r linguisticsdown::cond_cmpl("eː")`] - [`r linguisticsdown::cond_cmpl("ɛ")`] ($\hat\beta = .015, SE = .007, p < .041$) vowel pairs, this change was significantly indistinguishable from the F1-F2 cue combination (all other $ps > .06$). For the other comparisons, F1-F2 vs. F1-F3, and F1-F2 vs. F2-F3, the LMMs indicated significant negative changes for both comparisons for all but three vowel pairs: for the [`r linguisticsdown::cond_cmpl("iː")`] - [`r linguisticsdown::cond_cmpl("ɪ")`], there was a significant effect of cue combination in the F1-F2 vs. F1-F3 comparison only ($\hat\beta = -1.02, SE = .007, p < .0001$), for the [`r linguisticsdown::cond_cmpl("yː")`] - [`r linguisticsdown::cond_cmpl("ʏ")`] and [`r linguisticsdown::cond_cmpl("æː")`] - [`r linguisticsdown::cond_cmpl("æ")`] vowel pairs, there was a significant effect in the F1-F2 vs. F2-F3 comparison only (for [`r linguisticsdown::cond_cmpl("yː")`] - [`r linguisticsdown::cond_cmpl("ʏ")`], $\hat\beta = .023, SE = .006, p < .0002$; for [`r linguisticsdown::cond_cmpl("æː")`] - [`r linguisticsdown::cond_cmpl("æ")`], $\hat\beta = -.014, SE = .005, p < .011$).

To sum up, the results of the static analysis suggests that F1 and F2 are the most important cues to vowel distinctions in Central Swedish. While visual inspection suggested that including F3 did not substantially increase category separability for neighboring rounded vs. unrounded contrasts, the statistical analysis however found significant improvements in separability for all contrasts. This highlights subtle but significant differences, and the advantages of expanding empirical analyses to modeling approaches. 
...
Given that the category separability index assigns equal weight to all cues included in the index, there is no definite way of knowing which cue contributes more to the separability index. Furthermore, similar to other evaluations presented in this subsection, the separability index cannot account for the fact that formants are not static but rather fluctuate across the signal. A comprehensive mapping of the acoustics should therefore aim to assess how formant dynamics contribute to vowel distinctions. Such an analysis would inform us of which cues carry information about vowel quality and provide a more holistic picture of the vowel space. The next section investigates how formants move across the segment and how much information is gained by accounting for this dynamics.

### Dynamic spectral analysis {#sec:swehVd-dynamics}
This subsection begins with visualizations of the empirical data in formant trajectory plots. Next, the results of the GAMMs fit to the data are presented, first focusing on the movements in eight sets of neighboring vowel contrasts, then on spectral differences between the long and short vowel pairs.

#### Formant movements across the space {#sec:swehVd-trajectories}
Figure \@ref(fig:trajectories) displays the formant trajectories across all 5 time-points for the long and the short vowels. In almost all vowels, long or short, formants showed a dynamic pattern. Only the [`r linguisticsdown::cond_cmpl("øː")`], [`r linguisticsdown::cond_cmpl("ɪ")`], and [`r linguisticsdown::cond_cmpl("ʏ")`] vowels showed little movement over the measurement points. The scope and direction, however, vary. Considering the scope of movements across vowels, they appear to be larger moving from vowel mid-point to 80% into the vowel, as indicated by the length of the line from vowel label to end of arrow. Most of the formant dynamics thus take place *after* vowel mid-point. The long high front vowels are important exceptions---the dynamics in [`r linguisticsdown::cond_cmpl("iː")`] and [`r linguisticsdown::cond_cmpl("yː")`] mostly occur at the beginning of the vowel segment (between 20 and 50% into the vowel), whereas [`r linguisticsdown::cond_cmpl("ʉː")`] displays movements of almost equal magnitude across the first four time-points. The largest movements overall seem to concern [`r linguisticsdown::cond_cmpl("eː")`] and [`r linguisticsdown::cond_cmpl("oː")`].
...
The sets of neighboring contrasts investigated here all exhibited varying degrees of category overlap in static analysis. However, when formant dynamics was considered, the vowels in each contrast were all significantly different from each other along at least two cues [c.f., @fant1971; @kuronen2000; @pelzer-boersma2019]. For all contrasts, the vowels overlapped in parts of the segment, but importantly never along the entire segment (Figures \@ref(fig:m-high-front)**A-E**, \@ref(fig:m-high-back)**A-D-E**, \@ref(fig:m-center)**A**, \@ref(fig:m-mid)**A-B-E-F**). This indicates that category overlap found in static analysis is mitigated once temporal analysis is included, which suggests category distinctions unfold over time.

The results further indicate that even when formant dynamics are considered, F3 does not distinguish [`r linguisticsdown::cond_cmpl("iː")`] - [`r linguisticsdown::cond_cmpl("yː")`]. Considering the absence of an effect for F3, it is reasonable to assume that the dynamics in F1 and F2 are sufficient for a reliable distinction between the two vowels, and that F3-dynamics carries little information. Importantly, for the short [`r linguisticsdown::cond_cmpl("ɪ")`] - [`r linguisticsdown::cond_cmpl("ʏ")`], it is F1 rather than F3 that does not distinguish between the categories, suggesting overlap in F1 (height), but not F3 (lip-rounding).
...
par(mfrow=c(1,2))
itsadug::plot_smooth(m.F1.paired, view = "timepoint", plot_all = "category", col = c("#66C2A5", "#1B9E77"), print.summary = FALSE, cond = list(category = c("[iː]", "[ɪ]")), hide.label = T)
itsadug::plot_smooth(m.F3.paired, view = "timepoint", plot_all = "category", col = c("#66C2A5", "#1B9E77"), print.summary = FALSE, cond = list(category = c("[iː]", "[ɪ]")), hide.label = T)
#ggsave(file = "../../figures/p.png", width = 9, height = 5, dpi=1200)
```
...
While the static analysis suggested increased separability for the [`r linguisticsdown::cond_cmpl("iː")`] - [`r linguisticsdown::cond_cmpl("yː")`] contrast when F3 was included, this was not found under the assumption of formant dynamics. The GAMM fit to [`r linguisticsdown::cond_cmpl("iː")`] - [`r linguisticsdown::cond_cmpl("yː")`] - [`r linguisticsdown::cond_cmpl("ʉː")`] - [`r linguisticsdown::cond_cmpl("eː")`] contrast found no treatment effect of [`r linguisticsdown::cond_cmpl("yː")`] relative to [`r linguisticsdown::cond_cmpl("iː")`] predicting F3. However, the GAMM fit to [`r linguisticsdown::cond_cmpl("yː")`] - [`r linguisticsdown::cond_cmpl("ʏ")`] suggested statistically significant differences between the two categories predicting F3. These two analyses taken together suggest more effects on F3 in the short vowel compared to the long vowel.
...
Given the smaller number of talkers in SweDia, the two databases were of unequal sample sizes overall: N = `r nrow(d.SwehVd %>% distinct(Talker, category, Token))` datapoints for SwehVd, and N = `r nrow(d.SweDia2000 %>% filter(Location == "50") %>% distinct(Talker, category, Token))` datapoints for SweDia. The regional origin of the talkers matched across databases, age at the time of recording (mean age in SweDia = `r mean(d.SweDia2000.forStudy$Age, na.rm = T) %>% round(digits = 0)`, mean age in SwehVd = `r mean(d.SwehVd.forStudy$Age, na.rm = T) %>% round(digits = 0)`) and the relative proportion of male and female talkers were also highly similar (50% female talkers in SweDia2000, 55% female talkers in SwehVd). Any potential effect of differences in gender distributions on the comparison were presumably reduced by the use of normalized vowel data.
