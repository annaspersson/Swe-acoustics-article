...
The GAMMs fit to the high front vowel contrasts suggested significant constant differences between vowels in each contrast for all cues and contrasts (all $ps < .0001$), except for [`r linguisticsdown::cond_cmpl("iː")`] - [`r linguisticsdown::cond_cmpl("yː")`] predicting F3 ($\hat\beta = .0004, SE = .011, p > .97$), and [`r linguisticsdown::cond_cmpl("ɪ")`] - [`r linguisticsdown::cond_cmpl("ʏ")`] predicting F1 ($\hat\beta = .007, SE = .007, p > .32$) (Figures \@ref(fig:m-high-front-I-Y) and \@ref(fig:m-high-front-I-U-E)). There were further significant non-linear differences over time between vowels in each contrast for all cues (all $ps < .017$) except for [`r linguisticsdown::cond_cmpl("iː")`] - [`r linguisticsdown::cond_cmpl("yː")`] predicting F1 ($EDF = 1.5, F = .44, p > .51$), and [`r linguisticsdown::cond_cmpl("ɪ")`] - [`r linguisticsdown::cond_cmpl("ʏ")`] predicting F2 ($EDF = 1, F = 2.8, p > .09$). This suggests that there are no differences in [`r linguisticsdown::cond_cmpl("iː")`] and [`r linguisticsdown::cond_cmpl("yː")`] predicting F3 or in [`r linguisticsdown::cond_cmpl("ɪ")`] and [`r linguisticsdown::cond_cmpl("ʏ")`] predicting F1 when formant dynamics is considered. These results would thus overall seem to suggest that while F3 increases separability between [`r linguisticsdown::cond_cmpl("iː")`] and [`r linguisticsdown::cond_cmpl("yː")`] under static analysis, the *dynamics* in F3 does not seem to add information about vowel quality for this contrast. For the [`r linguisticsdown::cond_cmpl("ɪ")`] - [`r linguisticsdown::cond_cmpl("ʏ")`] contrast, F3 is likely more informative, while the F1-dynamics does not contribute to distinguishing between the two. Finally, all vowels in each contrast display different non-linear patterns, except for [`r linguisticsdown::cond_cmpl("iː")`] - [`r linguisticsdown::cond_cmpl("yː")`] along F1 and [`r linguisticsdown::cond_cmpl("ɪ")`] - [`r linguisticsdown::cond_cmpl("ʏ")`] along F2.
...
#ggsave(file = "../../figures/p.png", width = 9, height = 5, dpi=1200)
```
(ref:m-high-front-I-U-E) Fitted smooths of GAMM for predicting F1 (**upper row**), F2 (**mid row**), F3 (**bottom row**) and 95% confidence intervals for the long vowels [`r linguisticsdown::cond_cmpl("iː")`] - [`r linguisticsdown::cond_cmpl("ʉː")`] (**left**), and [`r linguisticsdown::cond_cmpl("iː")`] - [`r linguisticsdown::cond_cmpl("eː")`] (**right**). Differences significantly different from 0 are marked by black dotted vertical lines.
...
#ggsave(file = "../../figures/p.png", width = 9, height = 5, dpi=1200)
```
Significant constant as well as non-linear effects of category on all three cues was found in all GAMMs fit to the high back long and short contrasts (for constant differences, all $ps < .0006$; for non-linear differences, all $ps < .012$). These results suggest that all three cues contribute to distinguishing between these vowels also when formant dynamics are considered (Figure \@ref(fig:m-high-back)).
...
#ggsave(file = "../../figures/p.png", width = 9, height = 5, dpi=1200)
```
The GAMMs fit to the lower-mid front long and short vowel contrasts suggested both a constant and a non-linear effect of vowel on F1 and F2 (for constant differences, all $ps < .0001$; for non-linear differences, all $ps < .0024$). For F3, there were no significant constant differences between [`r linguisticsdown::cond_cmpl("ɛː")`] and [`r linguisticsdown::cond_cmpl("æː")`] ($\hat\beta = -.008, SE = .007, p > .25$), and no constant or non-linear differences between [`r linguisticsdown::cond_cmpl("ɛ")`] and [`r linguisticsdown::cond_cmpl("æ")`] ($\hat\beta = .008, SE = .006, p > .14$; $EDF = 1, F = .7, p > .4$). Figure \@ref(fig:m-center) demonstrates how these vowels overlap in F3-dynamics, but are distinguished for most of the segment along F1 and F2.
...
Finally, for the GAMMs fitted to the mid center vowels, there was an effect of category on all cue evaluations for both long and short vowels (all $ps < .026$ for both smooth and constant differences; Figure \@ref(fig:m-mid)), with the exception of the long vowels fit to F1, for which no constant difference was found (for [`r linguisticsdown::cond_cmpl("øː")`] - [`r linguisticsdown::cond_cmpl("œː")`], $\hat\beta = -.012, SE = .008, p > .12$). This contrast nevertheless displayed non-linear differences over time (Figure \@ref(fig:m-mid)). These results would seem to suggest that when formant dynamics are considered, F1 does not carry information about vowel quality for the [`r linguisticsdown::cond_cmpl("øː")`] - [`r linguisticsdown::cond_cmpl("œː")`] contrast. However, the two vowels display different non-linear patterns.
...
The second set of GAMMs modeled the effect of category on F1, F2, and F3 for all long and short vowel pairs. Summary tables and visualizations of these GAMMs are included in the SI (Section \@ref(sec:SI-GAMMs)). There was a treatment effect of vowel on all spectral cues for all vowel pairs, driven by both constant (for F1, all $ps < .016$; for F2, all $ps < .001$, for F3, all $ps < .044$) and non-linear differences (for F1, all $ps < .004$; for F2, all $ps < .01$, for F3, all $ps < .012$), except for [`r linguisticsdown::cond_cmpl("ɛː")`] - [`r linguisticsdown::cond_cmpl("ɛ")`] ($\hat\beta = -.0009, SE = .008, p > .9$) and [`r linguisticsdown::cond_cmpl("ɑː")`] - [`r linguisticsdown::cond_cmpl("a")`] ($\hat\beta = -.0006, SE = .01, p > .95$; $EDF = 2.25, F = 2.3, p > .08$) along F3. This would thus seem to suggest that F3 does not reliably distinguish between these long-short vowel pairs when dynamics is considered.^[For the long-short evaluations, an effect of gender was found for the [`r linguisticsdown::cond_cmpl("iː")`] - [`r linguisticsdown::cond_cmpl("ɪ")`], [`r linguisticsdown::cond_cmpl("yː")`] - [`r linguisticsdown::cond_cmpl("ʏ")`] and [`r linguisticsdown::cond_cmpl("oː")`] - [`r linguisticsdown::cond_cmpl("ɔ")`] contrasts predicting F1 (all $ps < .021$), for the [`r linguisticsdown::cond_cmpl("ɑː")`] - [`r linguisticsdown::cond_cmpl("a")`] and [`r linguisticsdown::cond_cmpl("uː")`] - [`r linguisticsdown::cond_cmpl("ʊ")`] contrasts predicting F2 (all $ps < .018$), and the [`r linguisticsdown::cond_cmpl("ɑː")`] - [`r linguisticsdown::cond_cmpl("a")`] contrast predicting F3 ($p < .016$).]<!--insignificant smooth diffs in [`r linguisticsdown::cond_cmpl("uː")`] - [`r linguisticsdown::cond_cmpl("ʊ")`] along F2 ($EDF = 2.25, F = 2.3, p > .08$); [`r linguisticsdown::cond_cmpl("æː")`] - [`r linguisticsdown::cond_cmpl("æ")`] along F3 ($EDF = 1, F = 1.53, p > .21$)]; [`r linguisticsdown::cond_cmpl("æː")`] - [`r linguisticsdown::cond_cmpl("æ")`] along F1 ($EDF = 1.4, F = 1.68, p > .32$)]; [`r linguisticsdown::cond_cmpl("œː")`] - [`r linguisticsdown::cond_cmpl("œ")`] along F3 ($EDF = 1, F = 3.38, p > .06$)]-->

With the exception of the [`r linguisticsdown::cond_cmpl("yː")`] - [`r linguisticsdown::cond_cmpl("ʏ")`] vowel pair, all rounded vowels displayed lower F3 values, hence more lip-rounding, in their long allophones [e.g., @hadding1976; @stalhammar1973]. The results suggest that when formant dynamics are considered, *all* long-short Central Swedish vowel pairs differ in spectral cues. Among the pairs that displayed smaller, albeit statistically significant, differences in spectral cues are the [`r linguisticsdown::cond_cmpl("iː")`] - [`r linguisticsdown::cond_cmpl("ɪ")`] pair predicting F1, possibly indicating a tendency for stronger duration dependency, in line with previous perceptual work [@behne-kirk1997]. Overall, larger effects were found for F2 which would support the hypothesis that F2 carries more of the durational variation in quantity contrasts in Swedish. Unsurprisingly, non-significant differences within pairs were found only for GAMMs predicting F3, which highlights the primary importance of F1-F2 as spectral cues to quantity contrasts under the assumption of formant dynamics.
