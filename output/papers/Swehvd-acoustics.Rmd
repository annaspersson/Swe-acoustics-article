...
The spectral cues are then modeled with GAMMs, first focusing on the movements in all 21 categories, then on spectral differences between the long and short vowel pairs, in order to assess to what extent dynamic information adds to the relative contribution of each of the cues to vowel distinctions.
