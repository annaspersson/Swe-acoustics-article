...
get_category_separability <- function(
  ...
  data %>% 
    ...
    mutate(
      ...
      distance_F1F2F3duration = sqrt((F1 - F1_mean)^2 + (F2 - F2_mean)^2 + (F3 - F3_mean)^2 + (Duration - Duration_mean)^2),
      ...
      category_separabilityF1F2F3duration = sum(distance_F1F2F3duration) / length(distance_F1F2F3duration))
  }
...
```{r cat-sep-F3, fig.align='center', fig.width=base.width*3, fig.height=base.height*1.75, out.width='90%', fig.cap="(ref:cat-sep-F3)", message=FALSE}
...
p.category.separability <- d.SwehVd.cat.separability.for.rounding %>%
  group_by(comparison, rounding, cue_dimension) %>%
  #summarise(across(c(separability, SE), ~ mean(.x, na.rm = T))) %>%
  mutate(
...
```
```{r}
contrasts(d.SwehVd.cat.separability.for.rounding$cue_dimension) <- contr.sum(2)
...
d.SwehVd.cat.separability.long.short <- rbind(
  ...
  summarise(
      ...
      F1F2_separability = mean(category_separabilityF1F2, na.rm = T),
      F1F2F3_separability = mean(category_separabilityF1F2F3, na.rm = T),
      F1F2F3duration_separability = mean(category_separabilityF1F2F3duration, na.rm = T))
...
d.SwehVd.cat.separability.for.longshort <- d.SwehVd.cat.separability.long.short %>%
  ...
  pivot_wider(
    ...
    values_from = "value") %>%
  mutate(
    cue_dimension = factor(cue_dimension, levels = c("F1F2", "F1F2F3", "F1F2F3duration"), labels = c("F1F2", "F1F2F3", "F1F2F3Duration")))
```
...
p.category.separability.long.short <- p.category.separability %+%
  (d.SwehVd.cat.separability.for.longshort %>%
     ...
     group_by(comparison, cue_dimension, height) %>%
     #summarise(across(c(separability, SE), ~ mean(.x, na.rm = T))) %>%
     mutate(
       ci = list(enframe(Hmisc::smean.cl.boot(separability)))) %>%
     unnest(ci) %>%
...
# Rename contrast labels
d.SwehVd.cat.separability.for.longshort$cue_dimension <- factor(d.SwehVd.cat.separability.for.longshort$cue_dimension, labels = c("F1F2", "F1F2F3", "F1F2F3Duration"))
...
#front vowels
d.model.front.long$categoryO <- as.ordered(d.model.front.long$category)
contrasts(d.model.front.long$categoryO) <- contr.treatment(4)
...
# Rename contrast labels
d.model.front.long$categoryO <- factor(d.model.front.long$categoryO, labels = c("[iː]", "[yː]", "[ʉː]", "[eː]"))
...
m.F1.front.long.ord <- mgcv::bam(F1 ~ categoryO + Gender + s(timepoint, k = 5) + s(timepoint, by = categoryO, k = 5)
                                + s(Talker, bs = "re")
                                + s(Talker, categoryO, bs = "re"),
                                data = d.model.front.long)

m.F2.front.long.ord <- mgcv::bam(F2 ~ categoryO + Gender + s(timepoint, k = 5) + s(timepoint, by = categoryO, k = 5)
                                + s(Talker, bs = "re")
                                + s(Talker, categoryO, bs = "re"),
                                data = d.model.front.long)

m.F3.front.long.ord <- mgcv::bam(F1 ~ categoryO + Gender + s(timepoint, k = 5) + s(timepoint, by = categoryO, k = 5)
                                + s(Talker, bs = "re")
                                + s(Talker, categoryO, bs = "re"),
                                data = d.model.front.long)
...
m.F3.front.short.ord <- mgcv::bam(F1 ~ categoryO + Gender + s(timepoint, k = 5) + s(timepoint, by = categoryO, k = 5)
                                + s(Talker, bs = "re")
                                + s(Talker, categoryO, bs = "re"),
                                data = d.model.front.short)
```
...
m.F3.back.long.ord <- mgcv::bam(F1 ~ categoryO + Gender + s(timepoint, k = 5) + s(timepoint, by = categoryO, k = 5)
                                + s(Talker, bs = "re")
                                + s(Talker, categoryO, bs = "re"),
                                data = d.model.back.long)
...
m.F3.back.short.ord <- mgcv::bam(F1 ~ categoryO + Gender + s(timepoint, k = 5) + s(timepoint, by = categoryO, k = 5)
                                + s(Talker, bs = "re")
                                + s(Talker, categoryO, bs = "re"),
                                data = d.model.back.short)
```
...
m.F3.center.long.ord <- mgcv::bam(F1 ~ categoryO + Gender + s(timepoint, k = 5) + s(timepoint, by = categoryO, k = 5)
                                + s(Talker, bs = "re")
                                + s(Talker, categoryO, bs = "re"),
                                data = d.model.center.long)
...
m.F3.center.short.ord <- mgcv::bam(F1 ~ categoryO + Gender + s(timepoint, k = 5) + s(timepoint, by = categoryO, k = 5)
                                + s(Talker, bs = "re")
                                + s(Talker, categoryO, bs = "re"),
                                data = d.model.center.short)
```
...
m.F3.mid.long.ord <- mgcv::bam(F1 ~ categoryO + Gender + s(timepoint, k = 5) + s(timepoint, by = categoryO, k = 5)
                                + s(Talker, bs = "re")
                                + s(Talker, categoryO, bs = "re"),
                                data = d.model.mid.long)
...
m.F3.mid.short.ord <- mgcv::bam(F1 ~ categoryO + Gender + s(timepoint, k = 5) + s(timepoint, by = categoryO, k = 5)
                                + s(Talker, bs = "re")
                                + s(Talker, categoryO, bs = "re"),
                                data = d.model.mid.short)
```
...
par(mfrow=c(3,2))
plot_diff(m.F1.front.long.ord, view = "timepoint", comp = list(categoryO = c("[iː]", "[yː]")), print.summary = F, col = "#1B9E77", hide.label = T, main = "A")
plot_diff(m.F1.front.short.ord, view = "timepoint", comp = list(categoryO = c("[ɪ]", "[ʏ]")), print.summary = F, col = "#1B9E77", hide.label = T, main = "B")
plot_diff(m.F2.front.long.ord, view = "timepoint", comp = list(categoryO = c("[iː]", "[yː]")), print.summary = F, col = "#1B9E77",hide.label = T, main = "C")
plot_diff(m.F2.front.short.ord, view = "timepoint", comp = list(categoryO = c("[ɪ]", "[ʏ]")), print.summary = F, col = "#1B9E77", hide.label = T, main = "D")
plot_diff(m.F3.front.long.ord, view = "timepoint", comp = list(categoryO = c("[iː]", "[yː]")), print.summary = F, col = "#1B9E77", hide.label = T, main = "E")
plot_diff(m.F3.front.short.ord, view = "timepoint", comp = list(categoryO = c("[ɪ]", "[ʏ]")), print.summary = F, col = "#1B9E77", hide.label = T, main = "F")
...
par(mfrow=c(3,2))
plot_diff(m.F1.back.long.ord, view = "timepoint", comp = list(categoryO = c("[oː]", "[uː]")), print.summary = F, col = "#A6CEE3", hide.label = T, main = "A")
plot_diff(m.F1.back.short.ord, view = "timepoint", comp = list(categoryO = c("[ɔ]", "[ʊ]")), print.summary = F, col = "#1F78B4", hide.label = T, main = "B")
plot_diff(m.F2.back.long.ord, view = "timepoint", comp = list(categoryO = c("[oː]", "[uː]")), print.summary = F, col = "#A6CEE3", hide.label = T, main = "C")
plot_diff(m.F2.back.short.ord, view = "timepoint", comp = list(categoryO = c("[ɔ]", "[ʊ]")), print.summary = F, col = "#1F78B4", hide.label = T, main = "D")
plot_diff(m.F3.back.long.ord, view = "timepoint", comp = list(categoryO = c("[oː]", "[uː]")), print.summary = F, col = "#A6CEE3", hide.label = T, main = "E")
plot_diff(m.F3.back.short.ord, view = "timepoint", comp = list(categoryO = c("[ɔ]", "[ʊ]")), print.summary = F, col = "#1F78B4", hide.label = T, main = "F")
#ggsave(file = "../../figures/p.png", width = 9, height = 5, dpi=1200)
```
...
par(mfrow=c(3,2))
plot_diff(m.F1.center.long.ord, view = "timepoint", comp = list(categoryO = c("[ɛː]", "[æː]")), print.summary = F, col = "#E78AC3", hide.label = T, main = "A")
plot_diff(m.F1.center.short.ord, view = "timepoint", comp = list(categoryO = c("[ɛ]", "[æ]")), print.summary = F, col = "#E7298A", hide.label = T, main = "B")
plot_diff(m.F2.center.long.ord, view = "timepoint", comp = list(categoryO = c("[ɛː]", "[æː]")), print.summary = F, col = "#E78AC3", hide.label = T, main = "C")
plot_diff(m.F2.center.short.ord, view = "timepoint", comp = list(categoryO = c("[ɛ]", "[æ]")), print.summary = F, col = "#E7298A", hide.label = T, main = "D")
plot_diff(m.F3.center.long.ord, view = "timepoint", comp = list(categoryO = c("[ɛː]", "[æː]")), print.summary = F, col = "#E78AC3", hide.label = T, main = "E")
plot_diff(m.F3.center.short.ord, view = "timepoint", comp = list(categoryO = c("[ɛ]", "[æ]")), print.summary = F, col = "#E7298A", hide.label = T, main = "F")
```
...
par(mfrow=c(3,2))
plot_diff(m.F1.mid.long.ord, view = "timepoint", comp = list(categoryO = c("[øː]", "[œː]")), print.summary = F, col = "#FFD92F", hide.label = T, main = "A")
plot_diff(m.F1.mid.short.ord, view = "timepoint", comp = list(categoryO = c("[ø]", "[œ]")), print.summary = F, col = "#E6AB02", hide.label = T, main = "B")
plot_diff(m.F2.mid.long.ord, view = "timepoint", comp = list(categoryO = c("[øː]", "[œː]")), print.summary = F, col = "#FFD92F", hide.label = T, main = "A")
plot_diff(m.F2.mid.short.ord, view = "timepoint", comp = list(categoryO = c("[ø]", "[œ]")), print.summary = F, col = "#E6AB02", hide.label = T, main = "B")
plot_diff(m.F3.mid.long.ord, view = "timepoint", comp = list(categoryO = c("[øː]", "[œː]")), print.summary = F, col = "#FFD92F", hide.label = T, main = "A")
plot_diff(m.F3.mid.short.ord, view = "timepoint", comp = list(categoryO = c("[ø]", "[œ]")), print.summary = F, col = "#E6AB02", hide.label = T, main = "B")
#ggsave(file = "../../figures/p.png", width = 9, height = 5, dpi=1200)
```
