...
itsadug::plot_smooth(m.F3.long, view = "Location", plot_all = "category", col = c("#66C2A5", "#FC8D62", "#8DA0CB"), print.summary = FALSE)
```
...
itsadug::plot_smooth(m.F3.short, view = "Location", plot_all = "category", col = c("#1B9E77", "#D95F02", "#7570B3"), print.summary = FALSE)
```
