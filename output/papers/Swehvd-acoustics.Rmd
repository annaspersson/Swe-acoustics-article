...
The dynamic spectral differences between the long-short vowel pairs, as well as the possible dependence on formant dynamics for i-y distinctions, were also investigated in dynamic analyses, see Section \@ref(sec:swehVd-dynamics) below.<!--change this-->
