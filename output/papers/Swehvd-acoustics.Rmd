...
bibliography      : ["latex-stuff/librarySweAcoust.bib"]
link-citations    : yes
...
The GAMMs suggested a main effect of category on F1 for all vowels in both datasets (all $ps > .008$), except for [`r linguisticsdown::cond_cmpl("ʏ")`] ($\hat\beta = .012, se = .014, p > .37$) which indicates overlap with [`r linguisticsdown::cond_cmpl("ɪ")`] in height (Figures \@ref(fig:m-F1-long) and \@ref(fig:m-F1-short)).
...
(ref:m-F1-long) Fitted smooths of GAMM for predicting F1 and 95% confidence intervals for the long vowels.
...
(ref:m-F1-short) Fitted smooths of GAMM for predicting F1 and 95% confidence intervals for the short vowels.
...
(ref:m-F2-short) Fitted smooths of GAMM for predicting F2 and 95% confidence intervals for the short vowels.
...
(ref:m-F3-short) Fitted smooths of GAMM for predicting F3 and 95% confidence intervals for the short vowels.
