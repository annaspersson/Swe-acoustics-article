...
itsadug::plot_smooth(m.F3, view = "Location", plot_all = "category", col = c("#66C2A5", "#FC8D62", "#8DA0CB"), print.summary = FALSE, cond = list(category = c("[iː]", "[yː]", "[ʉː]")))
```
...
itsadug::plot_smooth(m.F3.short, view = "Location", plot_all = "category", col = c("#1B9E77", "#D95F02", "#7570B3"), print.summary = FALSE, cond = list(category = c("[ɪ]", "[ʏ]", "[ɵ]")))
```
...
Table \@ref(tab:opr-table) lists all the vowels $V_{vowel}$ tested along with their corresponding anchor points, $U_{anchor}$ and $W_{anchor}$. These were all vowels for which the overall distance in F1 and F2 category means in SwehVd, compared to SweDia, $>= .75$ standard deviations from the category means in SweDia.
